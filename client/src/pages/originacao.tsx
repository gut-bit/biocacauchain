...
import {
    ...
    Shield, Building2, User, Users, Lock
} from "lucide-react";
        ...
        <div className="min-h-screen bg-white">
            ...
            <header className="bg-white border-b border-gray-200 px-6 py-4 sticky top-0 z-50 shadow-sm">
                <div className="container mx-auto flex items-center justify-between max-w-6xl">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-gray-900">Gutcacau — Originação</span>
                    </div>
                    <div className="w-24" />
                </div>
            </header>
            ...
            <section className="bg-gradient-to-br from-green-800 to-green-950 text-white py-20 px-6">
                <div className="container mx-auto max-w-4xl text-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
                        {[
                            ...
                            },
                            {
                                ...
                                href: "/admin-login", // Futuro endpoint de login interno
                    ...
                    {/* Link secundário de Rastreabilidade */}
